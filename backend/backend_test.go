...
func rootFingerprint1() []byte {
	return []byte{0x55, 0x55, 0x55, 0x55}
}

func rootFingerprint2() []byte {
	return []byte{0x66, 0x66, 0x66, 0x66}
}

func rootFingerprint1Func() ([]byte, error) {
	return rootFingerprint1(), nil
}

func rootFingerprint2Func() ([]byte, error) {
...
func makeBitBox02Multi() *keystoremock.KeystoreMock {
	return &keystoremock.KeystoreMock{
		...
		RootFingerprintFunc: rootFingerprint1Func,
